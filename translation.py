...
Made by @naviya2 🇱🇰
Support Group : empty 🇱🇰
Updates Channel : Empty 🇱🇰
"""
    ABOUT_TEXT = """
- **Bot :** `EL-downloader`
- **Creator :** [AJMAL](https://telegram.me/A_J_M_A_L)
- **Updates Channel :** [EL Updates 🇱🇰](hello makale)
- **Support Group :** EL Support 🇱🇰](support onnum venda makale)
...
"""
    START_BUTTONS = InlineKeyboardMarkup(
        [[
        InlineKeyboardButton('Developer🧑‍💻', url='https://t.me/A_J_M_A_L'),
        InlineKeyboardButton('Rate us ★', url='https://t.me/tlgrmcbot?start=leoyoutubedownloaderbot-review')
        ],[
        InlineKeyboardButton('Updates Channel 🗣', url='He he'),
        InlineKeyboardButton('Support Group 👥', url='poda poyi vala vazhayum vey')
        ],[
